...
public class BookshelfController {
    ...
    @Autowired
    public BookshelfController(BookshelfService bookshelfService, BookService bookService, AuthorService authorService,
    ...
    public List<Bookshelf> getBookshelves() {
        bookshelfService.assignBookToUser(userService.getUsers().get(0), bookService.getBooks().get(3));
        return bookshelfService.getBookshelves();
    }
